      ...
      return (
        <div className="min-h-screen bg-[#13141f] flex flex-col items-center justify-center px-6 py-10 text-center overflow-y-auto">
          ...
          <div className="text-gray-400 mb-6 text-sm">
            واجه التطبيق مشكلة غير متوقعة. يمكنك نسخ تفاصيل الخطأ أدناه وإرسالها للمطور.
          </div>
          ...
          <div className="flex flex-col w-full max-w-md gap-3">
            ...
            <button
              ...
              className="w-full px-4 py-3 rounded-xl bg-gray-800 text-white font-bold active:scale-95 transition-all border border-gray-700"
            >
              محاولة الاستمرار
            </button>
          </div>
